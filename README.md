# GDPR Compliance Agent — Production Agentic RAG on Databricks

An AI-powered compliance agent that enables internal retail teams to query GDPR legislation, enforcement case law, and internal policy documents through a natural language interface. Built end-to-end on Databricks with a CI/CD evaluation harness, production monitoring, and a FastAPI layer deployed on GCP Cloud Run.
